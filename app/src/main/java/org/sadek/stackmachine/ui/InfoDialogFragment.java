...
import org.sadek.stackmachine.R;
import org.sadek.stackmachine.app.AppSettings;
import org.sadek.stackmachine.io.IO;
import org.sadek.stackmachine.io.Savelog;

import java.io.IOException;

public class InfoDialogFragment extends DialogFragment {
    private static final String TAG = InfoDialogFragment.class.getSimpleName()+"_class";
    private static final boolean debug = AppSettings.defaultDebug;

    public static final String dialogTag = InfoDialogFragment.class.getSimpleName()+"_tag";
    private static final String EXTRA_id = InfoDialogFragment.class.getSimpleName()+".id";

    private CharSequence mData = null;
    private TextView mTextView = null;
    private Button mOkButton = null;

    public static InfoDialogFragment newInstance(int id) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mTextView = (TextView) v.findViewById(R.id.dialogInfo_content_id);
